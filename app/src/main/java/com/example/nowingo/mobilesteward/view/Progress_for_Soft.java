 ...
 */
public class Progress_for_Soft extends View {
    ...
    public Progress_for_Soft(Context context) {
        this(context,null);
    }

    public Progress_for_Soft(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public Progress_for_Soft(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    public Progress_for_Soft(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
